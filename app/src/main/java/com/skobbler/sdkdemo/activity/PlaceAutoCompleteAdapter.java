...
public class PlaceAutoCompleteAdapter
    ...
    private static final String API_KEY = "AIzaSyCk_5DBdQIe2Hm71TFxSmtIsyfCSw6yNnM";
    ...
    public static ArrayList<PlaceAutocomplete> autocomplete(String input) {
        ...
        try {
            ...
            Log.e("h", "Error processing Places API URL", e);
            return resultList;
        } catch (IOException e) {
            Log.e("h", "Error connecting to Places API", e);
            return resultList;
        } finally {
            if (conn != null) {
                conn.disconnect();
        ...
        try {
            ...
            Log.e("hi", "Cannot process JSON results", e);
        }
